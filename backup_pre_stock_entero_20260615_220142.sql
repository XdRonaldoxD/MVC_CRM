...
CREATE TABLE `boleta` (
  ...
  `valor_boleta` decimal(12,2) DEFAULT NULL,
  `fechacreacion_boleta` datetime DEFAULT NULL,
  `fechavencimiento_boleta` date DEFAULT NULL,
  `iva_boleta` decimal(12,2) DEFAULT NULL,
  `total_boleta` decimal(12,2) DEFAULT NULL,
  ...
  `saldo_boleta` decimal(12,2) DEFAULT NULL,
...
INSERT INTO `boleta` VALUES (42,125,1,23242,6,4,'BL01',11.02,'2026-06-13 12:57:42',NULL,1.98,13.00,NULL,NULL,'Documento_BOLETA202606131781373462.pdf',1,NULL,NULL,NULL,NULL,'Pendiente de envío manual a SUNAT','Ticket_202606131781373462.pdf','{\"ruta_xml\":null,\"ruta_zip\":null,\"Descripcion\":\"Pendiente de env\\u00edo manual a SUNAT\"}'),(43,127,1,23242,6,5,'BL01',10.17,'2026-06-13 13:02:24',NULL,1.83,12.00,NULL,NULL,'Documento_BOLETA202606131781373744.pdf',1,NULL,NULL,NULL,NULL,'Pendiente de envío manual a SUNAT','Ticket_202606131781373744.pdf','{\"ruta_xml\":null,\"ruta_zip\":null,\"Descripcion\":\"Pendiente de env\\u00edo manual a SUNAT\"}'),(44,128,1,23242,6,6,'BL01',22.03,'2026-06-13 18:38:19',NULL,3.97,26.00,NULL,NULL,'Documento_BOLETA202606131781393899.pdf',1,NULL,NULL,NULL,NULL,'Pendiente de envío manual a SUNAT','Ticket_202606131781393899.pdf','{\"ruta_xml\":null,\"ruta_zip\":null,\"Descripcion\":\"Pendiente de env\\u00edo manual a SUNAT\"}'),(45,139,1,23242,6,7,'BL01',11.86,'2026-06-15 19:07:49',NULL,2.14,14.00,NULL,NULL,'Documento_BOLETA202606151781568469.pdf',1,NULL,NULL,NULL,NULL,'Pendiente de envío manual a SUNAT','Ticket_202606151781568469.pdf','{\"ruta_xml\":null,\"ruta_zip\":null,\"Descripcion\":\"Pendiente de env\\u00edo manual a SUNAT\"}');
...
CREATE TABLE `caja` (
  ...
  `montoinicial_caja` decimal(12,2) NOT NULL DEFAULT '0.00',
...
INSERT INTO `caja` VALUES (30,NULL,108,'2024-01-07 10:51:12','2026-06-15 11:55:08',0,0.00),(31,NULL,122,'2024-01-09 21:36:21','2026-06-12 01:54:31',0,0.00),(33,NULL,122,'2026-06-14 00:07:35','2026-06-14 00:29:41',0,0.00),(34,NULL,122,'2026-06-14 01:01:42','2026-06-15 11:47:27',0,0.00),(35,NULL,122,'2026-06-15 12:42:23',NULL,1,0.00),(36,NULL,108,'2026-06-15 18:59:36',NULL,1,0.00);
...
CREATE TABLE `comprobante_ingreso` (
  ...
  `id_folio` int DEFAULT NULL,
  `id_usuario` int DEFAULT NULL,
  `valor_comprobante_ingreso` decimal(12,2) DEFAULT NULL,
...
CREATE TABLE `credito_cliente` (
  ...
  `id_cliente` int DEFAULT NULL,
  `id_usuario` int DEFAULT NULL,
  `cupomaximo_credito_cliente` decimal(12,2) DEFAULT NULL,
  `saldo_credito_cliente` decimal(12,2) DEFAULT NULL,
  `deuda_credito_cliente` decimal(12,2) DEFAULT NULL,
...
CREATE TABLE `descuento_global` (
  ...
  `porcentaje_descuento_global` decimal(6,2) DEFAULT NULL,
  `monto_descuento_global` decimal(12,2) DEFAULT NULL,
...
CREATE TABLE `despacho` (
  ...
  `valortotal_despacho` decimal(12,2) DEFAULT NULL,
...
CREATE TABLE `detalle_zona_oferta` (
  ...
  `preciolista_detalle_zona_oferta` decimal(12,2) DEFAULT NULL,
  `porcentajedescuento_detalle_zona_oferta` decimal(6,2) DEFAULT NULL,
  `preciototalventa_detalle_zona_oferta` decimal(12,2) DEFAULT NULL,
...
CREATE TABLE `egreso` (
  ...
  `valor_egreso` decimal(12,2) DEFAULT NULL,
...
CREATE TABLE `examenes` (
  ...
  `detalle_examen` text,
  `precio_examen` decimal(12,2) DEFAULT NULL,
...
CREATE TABLE `factura` (
  ...
  `valorafecto_factura` decimal(12,2) DEFAULT NULL,
  `valorexento_factura` decimal(12,2) DEFAULT NULL,
  `iva_factura` decimal(12,2) DEFAULT NULL,
  ...
  `saldo_factura` decimal(12,2) DEFAULT NULL,
...
INSERT INTO `folio` VALUES (1,'Orden de Compra',1,NULL),(2,'Negocio',367,NULL),(3,'Ficha',1,NULL),(4,'Ingreso',364,NULL),(5,'Comprobante de Ingreso',1,NULL),(6,'Boleta Afecta',8,'BL01'),(7,'Boleta Exenta',1,NULL),(8,'Nota de Credito',2,'BNL1'),(9,'Factura Afecta',46,'F111'),(10,'Comprobante Interno',1,NULL),(11,'Pedido',64,NULL),(12,'Nota de Credito',9,'FN01'),(13,'Factura Exenta',1,NULL),(14,'Nota Debito Boleta',1,NULL),(15,'Guia Despacho',1,NULL),(16,'Resumen Anulacion',1,'20210225'),(17,'Nota de Venta',195,'N001'),(18,'Egreso',18,NULL),(19,'Nota Debito Factura',1,NULL);
...
CREATE TABLE `guia_despacho` (
  ...
  `valorneto_guia_despacho` decimal(12,2) DEFAULT NULL,
  `iva_guia_despacho` decimal(12,2) DEFAULT NULL,
  `descuento_guia_despacho` decimal(12,2) DEFAULT NULL,
  `total_guia_despacho` decimal(12,2) DEFAULT NULL,
...
CREATE TABLE `ingreso` (
  ...
  `valor_ingreso` decimal(12,2) DEFAULT NULL,
...
CREATE TABLE `lista_precio` (
  ...
  `descuentoinicial_lista_precio` decimal(12,2) DEFAULT NULL,
...
INSERT INTO `marca` VALUES (65,'GENERICO',1),(66,'ESIKA',1),(67,'LBEL',1),(68,'AVON',1),(69,'FLORESTA FAMILIAR',1),(70,'ALKHOFAR',1),(71,'GELATTI',1),(72,'NATURAL DIRAS',1),(73,'ALOE VERA',1),(74,'SAL DE ANDREWS',1),(75,'AVAL',1),(76,'KOTEX',1),(77,'NOSOTROSAS',1),(78,'STAYFREE',1),(79,'LADYSOFT',1),(80,'DOVE',1),(81,'NEKO',1),(82,'MONCLER',1),(83,'ORAL-B',1),(84,'KOLYNOS',1),(85,'COLGATE',1),(86,'GILLETTE',1),(87,'DENTO',1),(88,'MIODEL',1),(89,'Labofar ',1),(90,'Gsk',0),(91,'Garden hause',1),(92,'Maver',0),(93,'Maver',1),(94,'UNILEVER',1),(95,'MARCA EDITADA CRM',0),(96,'BANES',1);
...
CREATE TABLE `negocio` (
  ...
  `valor_negocio` decimal(12,2) DEFAULT NULL,
  `descuento_negocio` decimal(12,2) DEFAULT NULL,
  `porcentajeiva_negocio` decimal(6,2) DEFAULT NULL,
  `estado_negocio` int DEFAULT NULL,
  `valorexento_negocio` decimal(12,2) DEFAULT NULL,
  `valorafecto_negocio` decimal(12,2) DEFAULT NULL,
  `cerrado_negocio` int DEFAULT NULL,
  `pos_negocio` int DEFAULT '0',
  `vigente_negocio` int DEFAULT NULL,
  `efectivo_negocio` decimal(12,2) DEFAULT NULL,
  `vuelto_negocio` decimal(12,2) DEFAULT NULL,
...
INSERT INTO `negocio` VALUES (125,23242,2,NULL,1,17,NULL,18,'2026-06-13 12:57:42',352,13.00,NULL,1.98,NULL,NULL,11.02,NULL,0,1,13.00,0.00),(126,23242,2,NULL,1,17,NULL,18,'2026-06-13 12:58:32',353,14.00,NULL,2.14,NULL,NULL,11.86,NULL,0,1,14.00,0.00),(127,23242,2,NULL,1,17,NULL,18,'2026-06-13 13:02:24',354,12.00,NULL,1.83,NULL,NULL,10.17,NULL,0,1,12.00,0.00),(128,23242,2,NULL,1,17,NULL,18,'2026-06-13 18:38:19',355,26.00,NULL,3.97,NULL,NULL,22.03,NULL,0,1,26.00,0.00),(129,23242,2,NULL,1,17,NULL,18,'2026-06-13 18:47:31',356,13.00,NULL,1.98,NULL,NULL,11.02,NULL,0,1,13.00,0.00),(130,23242,2,NULL,1,17,NULL,18,'2026-06-13 19:13:41',357,13.00,NULL,1.98,NULL,NULL,11.02,NULL,0,1,13.00,0.00),(131,23242,2,NULL,1,17,NULL,18,'2026-06-14 00:04:58',358,14.00,NULL,2.14,NULL,NULL,11.86,NULL,0,1,14.00,0.00),(132,23260,2,NULL,1,17,NULL,18,'2026-06-14 00:08:08',359,14.00,NULL,2.14,NULL,NULL,11.86,NULL,0,1,14.00,0.00),(133,23260,2,NULL,1,17,NULL,18,'2026-06-14 01:01:49',360,14.00,NULL,2.14,NULL,NULL,11.86,NULL,0,1,14.00,0.00),(134,23260,2,NULL,1,17,NULL,18,'2026-06-15 01:19:36',361,13.00,NULL,1.98,NULL,NULL,11.02,NULL,0,1,13.00,0.00),(135,23242,2,NULL,1,17,NULL,18,'2026-06-15 11:26:54',362,13.00,NULL,1.98,NULL,NULL,11.02,NULL,0,1,13.00,0.00),(136,23260,2,NULL,1,17,NULL,18,'2026-06-15 12:51:13',363,13.00,NULL,1.98,NULL,NULL,11.02,NULL,0,1,13.00,0.00),(137,23242,2,NULL,1,17,NULL,18,'2026-06-15 19:00:32',364,13.00,NULL,1.98,NULL,NULL,11.02,NULL,0,1,13.00,0.00),(138,23242,2,NULL,1,17,NULL,18,'2026-06-15 19:05:32',365,14.00,NULL,2.14,NULL,NULL,11.86,NULL,0,1,14.00,0.00),(139,23242,2,NULL,1,17,NULL,18,'2026-06-15 19:07:49',366,14.00,NULL,2.14,NULL,NULL,11.86,NULL,0,1,14.00,0.00);
...
CREATE TABLE `negocio_detalle` (
  ...
  `id_bodega` int DEFAULT NULL,
  `valorneto_negocio_detalle` decimal(12,2) DEFAULT NULL,
  `descuento_negocio_detalle` decimal(12,2) DEFAULT NULL,
  `iva_negocio_detalle` decimal(12,2) DEFAULT NULL,
  `total_negocio_detalle` decimal(12,2) DEFAULT NULL,
  `fechacreacion_negocio_detalle` datetime DEFAULT NULL,
  `cantidad_negocio_detalle` decimal(12,3) DEFAULT NULL,
  `valorafecto_negocio_detalle` decimal(12,2) DEFAULT NULL,
  `valorexento_negocio_detalle` decimal(12,2) DEFAULT NULL,
  ...
  `costohoradiashospital_negocio_detalle` decimal(12,2) DEFAULT NULL,
  `eshotel_hospital_negocio_detalle` int DEFAULT NULL,
  `asignadotratamiento_negocio_detalle` int DEFAULT NULL,
  `preciounitario_negocio_detalle` decimal(12,2) DEFAULT NULL,
...
INSERT INTO `negocio_detalle` VALUES (178,90,NULL,NULL,NULL,NULL,125,NULL,NULL,NULL,1,18,13.00,NULL,1.98,11.02,'2026-06-13 12:57:42',1.000,13.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,11.02),(179,90,NULL,NULL,NULL,NULL,126,NULL,NULL,NULL,1,18,13.00,NULL,1.98,11.02,'2026-06-13 12:58:32',1.000,13.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,11.02),(180,92,NULL,NULL,NULL,NULL,126,NULL,NULL,NULL,1,18,1.00,NULL,0.15,0.85,'2026-06-13 12:58:32',1.000,1.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0.85),(181,106,NULL,NULL,NULL,NULL,127,NULL,NULL,NULL,1,18,12.00,NULL,1.83,10.17,'2026-06-13 13:02:24',1.000,12.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,10.17),(182,92,NULL,NULL,NULL,NULL,128,NULL,NULL,NULL,1,18,1.00,NULL,0.15,0.85,'2026-06-13 18:38:19',1.000,1.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0.85),(183,90,NULL,NULL,NULL,NULL,128,NULL,NULL,NULL,1,18,13.00,NULL,1.98,11.02,'2026-06-13 18:38:19',1.000,13.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,11.02),(184,106,NULL,NULL,NULL,NULL,128,NULL,NULL,NULL,1,18,12.00,NULL,1.83,10.17,'2026-06-13 18:38:19',1.000,12.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,10.17),(185,90,NULL,NULL,NULL,NULL,129,NULL,NULL,NULL,1,18,13.00,NULL,1.98,11.02,'2026-06-13 18:47:31',1.000,13.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,11.02),(186,90,NULL,NULL,NULL,NULL,130,NULL,NULL,NULL,1,18,13.00,NULL,1.98,11.02,'2026-06-13 19:13:41',1.000,13.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,11.02),(187,92,NULL,NULL,NULL,NULL,131,NULL,NULL,NULL,1,18,1.00,NULL,0.15,0.85,'2026-06-14 00:04:58',1.000,1.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0.85),(188,90,NULL,NULL,NULL,NULL,131,NULL,NULL,NULL,1,18,13.00,NULL,1.98,11.02,'2026-06-14 00:04:58',1.000,13.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,11.02),(189,90,NULL,NULL,NULL,NULL,132,NULL,NULL,NULL,1,18,13.00,NULL,1.98,11.02,'2026-06-14 00:08:08',1.000,13.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,11.02),(190,92,NULL,NULL,NULL,NULL,132,NULL,NULL,NULL,1,18,1.00,NULL,0.15,0.85,'2026-06-14 00:08:08',1.000,1.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0.85),(191,90,NULL,NULL,NULL,NULL,133,NULL,NULL,NULL,1,18,13.00,NULL,1.98,11.02,'2026-06-14 01:01:49',1.000,13.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,11.02),(192,92,NULL,NULL,NULL,NULL,133,NULL,NULL,NULL,1,18,1.00,NULL,0.15,0.85,'2026-06-14 01:01:49',1.000,1.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0.85),(193,90,NULL,NULL,NULL,NULL,134,NULL,NULL,NULL,1,18,13.00,NULL,1.98,11.02,'2026-06-15 01:19:36',1.000,13.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,11.02),(194,90,NULL,NULL,NULL,NULL,135,NULL,NULL,NULL,1,18,13.00,NULL,1.98,11.02,'2026-06-15 11:26:54',1.000,13.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,11.02),(195,90,NULL,NULL,NULL,NULL,136,NULL,NULL,NULL,1,18,13.00,NULL,1.98,11.02,'2026-06-15 12:51:13',1.000,13.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,11.02),(196,90,NULL,NULL,NULL,NULL,137,NULL,NULL,NULL,1,18,13.00,NULL,1.98,11.02,'2026-06-15 19:00:32',1.000,13.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,11.02),(197,90,NULL,NULL,NULL,NULL,138,NULL,NULL,NULL,1,18,13.00,NULL,1.98,11.02,'2026-06-15 19:05:32',1.000,13.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,11.02),(198,92,NULL,NULL,NULL,NULL,138,NULL,NULL,NULL,1,18,1.00,NULL,0.15,0.85,'2026-06-15 19:05:32',1.000,1.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0.85),(199,90,NULL,NULL,NULL,NULL,139,NULL,NULL,NULL,1,18,13.00,NULL,1.98,11.02,'2026-06-15 19:07:49',1.000,13.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,11.02),(200,92,NULL,NULL,NULL,NULL,139,NULL,NULL,NULL,1,18,1.00,NULL,0.15,0.85,'2026-06-15 19:07:49',1.000,1.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0.85);
...
CREATE TABLE `nota_credito` (
  ...
  `valorafecto_nota_credito` decimal(12,2) DEFAULT NULL,
  `valorexento_nota_credito` decimal(12,2) DEFAULT NULL,
  `iva_nota_credito` decimal(12,2) DEFAULT NULL,
  `total_nota_credito` decimal(12,2) DEFAULT NULL,
...
CREATE TABLE `nota_debito` (
  ...
  `valorafecto_nota_debito` decimal(12,2) DEFAULT NULL,
  `valorexento_nota_debito` decimal(12,2) DEFAULT NULL,
  `iva_nota_debito` decimal(12,2) DEFAULT NULL,
  `total_nota_debito` decimal(12,2) DEFAULT NULL,
  `estado_nota_debito` decimal(12,2) DEFAULT NULL,
...
CREATE TABLE `nota_venta` (
  ...
  `valor_nota_venta` decimal(12,2) DEFAULT NULL,
  `iva_nota_venta` decimal(12,2) DEFAULT NULL,
  `total_nota_venta` decimal(12,2) DEFAULT NULL,
  `estado_nota_venta` int DEFAULT NULL,
  `saldo_nota_venta` decimal(12,2) DEFAULT NULL,
...
CREATE TABLE `orden_compra` (
  ...
  `porcentajeiva_orden_compra` decimal(6,2) DEFAULT NULL,
  `total_orden_compra` decimal(12,2) DEFAULT NULL,
...
CREATE TABLE `pedido` (
  ...
  `valorneto_pedido` decimal(12,2) DEFAULT NULL,
  `valortransporte_pedido` decimal(12,2) DEFAULT NULL,
  `descuento_pedido` decimal(12,2) DEFAULT NULL,
  `porcentajeiva_pedido` decimal(6,2) DEFAULT NULL,
  `iva_pedido` decimal(12,2) DEFAULT NULL,
  `valortotal_pedido` decimal(12,2) DEFAULT NULL,
  `retiroentienda_pedido` int DEFAULT NULL,
  `peso_pedido` decimal(12,3) DEFAULT NULL,
  `nota_pedido` text,
...
INSERT INTO `pedido` VALUES (45,23261,11,73,NULL,1,1,5,NULL,NULL,NULL,'2024-03-28 17:01:21','1',11.78,NULL,NULL,NULL,2.12,13.90,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(46,23261,11,73,NULL,1,1,5,NULL,NULL,NULL,'2024-03-28 17:09:15','2',23.56,NULL,NULL,NULL,4.24,27.80,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(47,23261,11,73,NULL,1,1,5,NULL,NULL,NULL,'2024-03-30 12:45:31','4',35.34,NULL,NULL,NULL,6.36,41.70,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(48,23261,11,73,NULL,1,1,5,NULL,NULL,NULL,'2024-03-30 12:48:27','5',47.12,NULL,NULL,NULL,8.48,55.60,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(49,23261,11,73,NULL,1,1,5,NULL,NULL,NULL,'2024-03-30 12:49:16','6',47.12,NULL,NULL,NULL,8.48,55.60,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(50,23261,11,73,NULL,1,1,5,NULL,NULL,NULL,'2024-03-30 12:51:14','7',47.12,NULL,NULL,NULL,8.48,55.60,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(51,23261,11,73,NULL,1,1,5,NULL,NULL,NULL,'2024-03-30 12:52:31','8',47.12,NULL,NULL,NULL,8.48,55.60,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(52,23261,11,73,NULL,1,1,5,NULL,NULL,NULL,'2024-03-30 12:53:22','9',47.12,NULL,NULL,NULL,8.48,55.60,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(53,23261,11,73,NULL,1,1,5,NULL,NULL,NULL,'2024-03-30 12:54:52','10',47.12,NULL,NULL,NULL,8.48,55.60,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(54,23261,11,73,NULL,1,1,5,NULL,NULL,NULL,'2024-03-30 12:55:43','11',47.12,NULL,NULL,NULL,8.48,55.60,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(55,23261,11,73,NULL,1,1,5,NULL,NULL,NULL,'2024-03-30 13:00:23','12',47.12,NULL,NULL,NULL,8.48,55.60,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(56,23261,11,73,NULL,1,1,5,NULL,NULL,NULL,'2024-03-30 13:13:56','13',47.12,NULL,NULL,NULL,8.48,55.60,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(99,23261,11,73,NULL,1,1,5,NULL,NULL,NULL,'2024-04-06 16:24:44','56',50.08,NULL,NULL,NULL,9.02,59.10,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(100,23261,11,73,NULL,1,1,5,NULL,NULL,NULL,'2024-04-06 16:37:36','57',50.08,NULL,NULL,NULL,9.02,59.10,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(101,23261,11,73,NULL,1,1,5,NULL,NULL,NULL,'2024-04-06 16:37:45','58',50.08,NULL,NULL,NULL,9.02,59.10,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(102,23261,11,73,NULL,1,1,5,NULL,NULL,NULL,'2024-04-06 16:38:15','59',50.08,NULL,NULL,NULL,9.02,59.10,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(103,23261,11,73,NULL,1,1,5,NULL,NULL,NULL,'2024-04-06 16:51:27','60',50.08,NULL,NULL,NULL,9.02,59.10,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(104,23261,11,73,NULL,1,1,5,NULL,NULL,NULL,'2024-04-06 17:02:42','61',13.47,NULL,NULL,NULL,2.43,15.90,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(105,23261,11,73,NULL,1,1,5,NULL,NULL,NULL,'2024-04-06 17:04:40','62',13.47,NULL,NULL,NULL,2.43,15.90,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(106,23261,11,73,NULL,1,1,5,NULL,NULL,NULL,'2024-04-08 17:38:51','63',13.47,NULL,NULL,NULL,2.43,15.90,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(107,23261,11,NULL,NULL,1,1,5,NULL,NULL,NULL,'2024-04-09 17:25:16','64',7.37,NULL,NULL,NULL,1.33,8.70,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `pedido_detalle` (
  ...
  `id_pedido` int DEFAULT NULL,
  `id_lista_precio` int DEFAULT NULL,
  `valorneto_pedido_detalle` decimal(12,2) DEFAULT NULL,
  `iva_pedido_detalle` decimal(12,2) DEFAULT NULL,
  `descuento_pedido_detalle` decimal(12,2) DEFAULT NULL,
  `valortotal_pedido_detalle` decimal(12,2) DEFAULT NULL,
...
INSERT INTO `pedido_detalle` VALUES (83,NULL,193,NULL,45,NULL,NULL,2.12,NULL,13.90,1,'2024-03-28 17:01:21',1),(84,NULL,193,NULL,46,NULL,NULL,2.12,NULL,13.90,2,'2024-03-28 17:09:15',1),(85,NULL,193,NULL,47,NULL,NULL,2.12,NULL,13.90,3,'2024-03-30 12:45:32',1),(86,NULL,193,NULL,48,NULL,NULL,2.12,NULL,13.90,4,'2024-03-30 12:48:27',1),(87,NULL,193,NULL,49,NULL,NULL,2.12,NULL,13.90,4,'2024-03-30 12:49:16',1),(88,NULL,193,NULL,50,NULL,NULL,2.12,NULL,13.90,4,'2024-03-30 12:51:14',1),(89,NULL,193,NULL,51,NULL,NULL,2.12,NULL,13.90,4,'2024-03-30 12:52:31',1),(90,NULL,193,NULL,52,NULL,NULL,2.12,NULL,13.90,4,'2024-03-30 12:53:22',1),(91,NULL,193,NULL,53,NULL,NULL,2.12,NULL,13.90,4,'2024-03-30 12:54:52',1),(92,NULL,193,NULL,54,NULL,NULL,2.12,NULL,13.90,4,'2024-03-30 12:55:43',1),(93,NULL,193,NULL,55,NULL,NULL,2.12,NULL,13.90,4,'2024-03-30 13:00:23',1),(94,NULL,193,NULL,56,NULL,NULL,2.12,NULL,13.90,4,'2024-03-30 13:13:56',1),(95,NULL,193,NULL,57,NULL,NUL
,NULL,103,NULL,NULL,0.23,NULL,1.50,1,'2024-04-06 16:51:27',3),(154,NULL,193,NULL,104,NULL,NULL,2.12,NULL,13.90,1,'2024-04-06 17:02:42',1),(155,NULL,191,NULL,104,NULL,NULL,0.31,NULL,2.00,1,'2024-04-06 17:02:42',2),(156,NULL,193,NULL,105,NULL,NULL,2.12,NULL,13.90,1,'2024-04-06 17:04:40',1),(157,NULL,191,NULL,105,NULL,NULL,0.31,NULL,2.00,1,'2024-04-06 17:04:40',2),(158,NULL,193,NULL,106,NULL,NULL,2.12,NULL,13.90,1,'2024-04-08 17:38:51',1),(159,NULL,191,NULL,106,NULL,NULL,0.31,NULL,2.00,1,'2024-04-08 17:38:51',2),(160,NULL,179,NULL,107,NULL,NULL,0.44,NULL,2.90,3,'2024-04-09 17:25:17',1);
...
INSERT INTO `perfil_modulo` VALUES (29,5,3,1),(30,5,5,1),(31,5,7,1),(32,5,9,1),(33,5,11,1),(34,5,12,1),(35,5,13,1);
...
CREATE TABLE `presupuesto_asignado` (
  ...
  `total_presupuesto_asignado` decimal(12,2) DEFAULT NULL,
...
CREATE TABLE `procedimientos` (
  ...
  `precio_procedimiento` decimal(12,2) DEFAULT NULL,
...
CREATE TABLE `producto` (
  ...
  `dosis_producto` decimal(12,3) DEFAULT NULL,
  `concentracion_producto` decimal(12,3) DEFAULT NULL,
  `cantidad_producto` decimal(12,3) DEFAULT NULL,
  `stock_producto` decimal(12,3) DEFAULT NULL,
  `stockcritico_producto` decimal(12,3) DEFAULT NULL,
  `aplicaiva_producto` int DEFAULT NULL,
  `preciocosto_producto` decimal(12,2) DEFAULT NULL,
  `precioventa_producto` decimal(12,2) DEFAULT NULL,
  `stockentransito_producto` decimal(12,3) DEFAULT NULL,
  `fechacreacion_producto` datetime DEFAULT NULL,
  `saldocantidad_producto` decimal(12,3) DEFAULT NULL,
  `contenidomultidosis_producto` decimal(12,3) DEFAULT NULL,
  `permitirvendersinstock_producto` int DEFAULT '0',
  `promedioglobalpreciocosto_producto` decimal(12,2) DEFAULT NULL,
  `urlamigable_producto` varchar(5000) DEFAULT NULL,
  `anchopaquete_producto` decimal(12,3) DEFAULT NULL,
  `altopaquete_producto` decimal(12,3) DEFAULT NULL,
  `profundidadpaquete_producto` decimal(12,3) DEFAULT NULL,
  `pesopaquete_producto` decimal(12,3) DEFAULT NULL,
...
CREATE TABLE `producto_historial` (
  ...
  `id_proveedor` int DEFAULT NULL,
  `id_bodega` int DEFAULT NULL,
  `cantidadmovimiento_producto_historial` decimal(12,3) DEFAULT NULL,
  `fecha_producto_historial` datetime DEFAULT NULL,
  `comentario_producto_historial` text,
  `preciocompra_producto_historial` decimal(12,2) DEFAULT NULL,
  ...
  `precioventa_producto_historial` decimal(12,2) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=495 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `producto_historial` VALUES (467,23242,2,90,NULL,18,1.000,'2026-06-13 12:57:42','BOLETA DE VENTA ELECTRONICA',NULL,1,NULL,NULL,NULL),(468,23242,2,90,NULL,18,1.000,'2026-06-13 12:58:32','NOTA VENTA DE VENTA ELECTRONICA',NULL,4,NULL,NULL,NULL),(469,23242,2,92,NULL,18,1.000,'2026-06-13 12:58:32','NOTA VENTA DE VENTA ELECTRONICA',NULL,4,NULL,NULL,NULL),(470,23242,2,106,NULL,18,1.000,'2026-06-13 13:02:24','BOLETA DE VENTA ELECTRONICA',NULL,1,NULL,NULL,NULL),(471,23242,2,92,NULL,18,1.000,'2026-06-13 18:38:19','BOLETA DE VENTA ELECTRONICA',NULL,1,NULL,NULL,NULL),(472,23242,2,90,NULL,18,1.000,'2026-06-13 18:38:19','BOLETA DE VENTA ELECTRONICA',NULL,1,NULL,NULL,NULL),(473,23242,2,106,NULL,18,1.000,'2026-06-13 18:38:19','BOLETA DE VENTA ELECTRONICA',NULL,1,NULL,NULL,NULL),(474,23242,2,90,NULL,18,1.000,'2026-06-13 18:47:31','NOTA VENTA DE VENTA ELECTRONICA',NULL,4,NULL,NULL,NULL),(475,23242,2,90,NULL,18,1.000,'2026-06-13 19:13:41','NOTA VENTA DE VENTA ELECTRONICA',NULL,4,NULL,NULL,NULL),(476,23242,2,92,NULL,18,1.000,'2026-06-14 00:04:58','NOTA VENTA DE VENTA ELECTRONICA',NULL,4,NULL,NULL,NULL),(477,23242,2,90,NULL,18,1.000,'2026-06-14 00:04:58','NOTA VENTA DE VENTA ELECTRONICA',NULL,4,NULL,NULL,NULL),(478,23260,2,90,NULL,18,1.000,'2026-06-14 00:08:08','NOTA VENTA DE VENTA ELECTRONICA',NULL,4,NULL,NULL,NULL),(479,23260,2,92,NULL,18,1.000,'2026-06-14 00:08:08','NOTA VENTA DE VENTA ELECTRONICA',NULL,4,NULL,NULL,NULL),(480,23260,2,90,NULL,18,1.000,'2026-06-14 01:01:49','NOTA VENTA DE VENTA ELECTRONICA',NULL,4,NULL,NULL,NULL),(481,23260,2,92,NULL,18,1.000,'2026-06-14 01:01:49','NOTA VENTA DE VENTA ELECTRONICA',NULL,4,NULL,NULL,NULL),(482,23260,1,196,NULL,18,12.000,'2026-06-14 10:09:54',NULL,100.00,NULL,NULL,NULL,12.00),(483,23260,1,195,NULL,18,2.000,'2026-06-14 11:08:44',NULL,0.00,NULL,NULL,NULL,120.00),(484,23260,1,195,NULL,18,4.000,'2026-06-14 11:09:08',NULL,0.00,NULL,NULL,NULL,101.00),(485,23260,1,195,NULL,18,5.000,'2026-06-14 11:15:49',NULL,0.00,NULL,NULL,NULL,101.00),(486,23260,2,90,NULL,18,1.000,'2026-06-15 01:19:36','NOTA VENTA DE VENTA ELECTRONICA',NULL,4,NULL,NULL,NULL),(487,23242,2,90,NULL,18,1.000,'2026-06-15 11:26:54','NOTA VENTA DE VENTA ELECTRONICA',NULL,4,NULL,NULL,NULL),(488,23260,2,90,NULL,18,1.000,'2026-06-15 12:51:13','NOTA VENTA DE VENTA ELECTRONICA',NULL,4,NULL,NULL,NULL),(489,23242,1,195,NULL,18,5.000,'2026-06-15 18:57:34',NULL,120.00,NULL,NULL,NULL,130.00),(490,23242,2,90,NULL,18,1.000,'2026-06-15 19:00:32','NOTA VENTA DE VENTA ELECTRONICA',NULL,4,NULL,NULL,NULL),(491,23242,2,90,NULL,18,1.000,'2026-06-15 19:05:32','NOTA VENTA DE VENTA ELECTRONICA',NULL,4,NULL,NULL,NULL),(492,23242,2,92,NULL,18,1.000,'2026-06-15 19:05:32','NOTA VENTA DE VENTA ELECTRONICA',NULL,4,NULL,NULL,NULL),(493,23242,2,90,NULL,18,1.000,'2026-06-15 19:07:49','BOLETA DE VENTA ELECTRONICA',NULL,1,NULL,NULL,NULL),(494,23242,2,92,NULL,18,1.000,'2026-06-15 19:07:49','BOLETA DE VENTA ELECTRONICA',NULL,1,NULL,NULL,NULL);
...
CREATE TABLE `servicio` (
  ...
  `costoferiado_servicio` decimal(12,2) DEFAULT NULL,
...
CREATE TABLE `staff` (
  ...
  `valorcomision_staff` decimal(12,2) DEFAULT NULL,
  ...
  `porcentajeurgencia_staff` decimal(6,2) DEFAULT NULL,
  ...
  `porcentajeprocedimiento_staff` decimal(6,2) DEFAULT NULL,
  `porcentajecirugia_staff` decimal(6,2) DEFAULT NULL,
...
CREATE TABLE `stock_producto_bodega` (
  ...
  `id_producto` int DEFAULT NULL,
  `id_bodega` int DEFAULT NULL,
  `total_stock_producto_bodega` decimal(12,3) DEFAULT NULL,
  `totalcritico_stock_producto_bodega` decimal(12,3) DEFAULT NULL,
  `stockentransito_stock_producto_bodega` decimal(12,3) DEFAULT NULL,
  `saldocantidad_stock_producto_bodega` decimal(12,3) DEFAULT NULL,
  `ultimopreciocompra_stock_producto_bodega` decimal(12,2) DEFAULT NULL,
  `precioventa_stock_producto_bodega` decimal(12,2) DEFAULT NULL,
...
INSERT INTO `stock_producto_bodega` VALUES (90,90,18,86.000,NULL,NULL,100.000,14.00,13.00),(91,91,18,100.000,NULL,NULL,100.000,0.00,NULL),(92,92,18,93.000,NULL,NULL,100.000,1.00,1.00),(93,93,18,100.000,NULL,NULL,100.000,0.00,NULL),(94,94,18,100.000,NULL,NULL,100.000,0.00,0.00),(95,95,18,100.000,NULL,NULL,100.000,0.00,NULL),(96,96,18,100.000,NULL,NULL,100.000,0.00,NULL),(97,97,18,100.000,NULL,NULL,100.000,0.00,NULL),(98,98,18,100.000,NULL,NULL,100.000,0.00,NULL),(99,99,18,100.000,NULL,NULL,100.000,0.00,NULL),(100,100,18,100.000,NULL,NULL,100.000,0.00,NULL),(101,101,18,100.000,NULL,NULL,100.000,0.00,NULL),(102,102,18,100.000,NULL,NULL,100.000,0.00,NULL),(103,103,18,100.000,NULL,NULL,100.000,0.00,0.00),(104,104,18,100.000,NULL,NULL,100.000,0.00,NULL),(105,105,18,100.000,NULL,NULL,100.000,0.00,NULL),(106,106,18,98.000,NULL,NULL,100.000,0.00,12.00),(107,107,18,100.000,NULL,NULL,100.000,0.00,NULL),(108,108,18,100.000,NULL,NULL,100.000,0.00,NULL),(109,109,18,100.000,NULL,NULL,100.000,0.00,NULL),(110,110,18,100.000,NULL,NULL,100.000,0.00,NULL),(111,111,
L,100.000,0.00,NULL),(161,161,18,100.000,NULL,NULL,100.000,0.00,NULL),(162,162,18,100.000,NULL,NULL,100.000,0.00,NULL),(163,163,18,100.000,NULL,NULL,100.000,0.00,NULL),(164,164,18,100.000,NULL,NULL,100.000,0.00,NULL),(165,165,18,100.000,NULL,NULL,100.000,0.00,NULL),(166,166,18,100.000,NULL,NULL,100.000,0.00,NULL),(167,167,18,100.000,NULL,NULL,100.000,0.00,NULL),(168,168,18,100.000,NULL,NULL,100.000,11.00,10.00),(169,169,18,100.000,NULL,NULL,100.000,0.00,0.00),(170,170,18,100.000,NULL,NULL,100.000,0.00,NULL),(171,171,18,100.000,NULL,NULL,100.000,0.00,NULL),(172,172,18,100.000,NULL,NULL,100.000,0.00,NULL),(173,173,18,100.000,NULL,NULL,100.000,0.00,0.00),(174,174,18,100.000,NULL,NULL,100.000,0.00,NULL),(175,175,18,100.000,NULL,NULL,100.000,1.00,1.50),(176,176,18,100.000,NULL,NULL,100.000,0.00,0.00),(177,177,18,100.000,NULL,NULL,100.000,2.00,2.50),(178,178,18,100.000,NULL,NULL,100.000,0.00,NULL),(179,179,18,100.000,NULL,NULL,100.000,2.00,2.90),(180,180,18,100.000,NULL,NULL,100.000,2.10,3.00),(181,181,18,100.000,NULL,NULL,100.000,1.75,2.50),(182,182,18,100.000,NULL,NULL,100.000,1.75,2.50),(183,183,18,100.000,NULL,NULL,100.000,10.50,15.00),(184,184,18,100.000,NULL,NULL,100.000,8.40,12.00),(185,185,18,100.000,NULL,NULL,100.000,2.30,3.40),(186,186,18,100.000,NULL,NULL,100.000,2.00,2.00),(187,187,18,100.000,NULL,NULL,100.000,3.45,4.00),(188,188,18,100.000,NULL,NULL,100.000,1.75,2.50),(189,189,18,100.000,NULL,NULL,100.000,1.05,1.50),(190,190,18,100.000,NULL,NULL,100.000,1.40,2.00),(191,191,18,100.000,NULL,NULL,100.000,1.05,1.50),(192,192,18,100.000,NULL,NULL,100.000,1.05,1.50),(193,193,18,100.000,NULL,NULL,100.000,9.45,13.50),(194,195,18,116.000,0.000,0.000,100.000,120.00,130.00),(195,196,18,112.000,0.000,0.000,100.000,100.00,12.00);
...
CREATE TABLE `stock_producto_bodega_atributo` (
  ...
  `id_atributo` int DEFAULT NULL,
  `id_staff` int DEFAULT NULL,
  `cantidad_stock_producto_bodega_atributo` decimal(12,3) DEFAULT NULL,
...
CREATE TABLE `tipo_despacho` (
  ...
  `preciodefecto_tipo_despacho` decimal(12,2) DEFAULT NULL,
...
CREATE TABLE `transportista_comuna` (
  ...
  `id_comuna` int DEFAULT NULL,
  `preciodefecto_transportista_comuna` decimal(12,2) DEFAULT NULL,
...
CREATE TABLE `transportista_pedido` (
  ...
  `id_transportista` int DEFAULT NULL,
  `id_pedido` int DEFAULT NULL,
  `valor_transportista_pedido` decimal(12,2) DEFAULT NULL,
  `vigente_transportista_pedido` int DEFAULT NULL,
  `peso_transportista_pedido` decimal(12,3) DEFAULT NULL,
...
-- Dump completed on 2026-06-15 22:01:43
